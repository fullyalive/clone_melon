...
function setFkCookie(name, value, expires, path, domain) {
	if(expires==null || expires==""){
		...
		var hours = new Date();
		hours.setHours(hours.getHours()+expires);
		document.cookie = name + "=" + escape(value) + ";" + "path=" + path + ";domain=" + domain + ";expires=" + hours.toGMTString();
	}
}
...
function isMelonLogin() {
  ...
  //우선 토큰 유효성 체크는 안하기로.
  //  var _loginDate = convertStringToDate(getMUACHeaderCookie('loginDate')).getTime(),
  //  	_currDate = new Date().getTime(),
  //  	_expireTime = 1000*60*60*24;
  //
    //// 기본 24일, 앱일경우 180일
    //mstApp.isApp() && (_expireTime * 180);
    //
    //if (_expireTime < (_currDate - _loginDate)) {
    //	$.ajax({
    //		url: 'http://member.melon.com/muid/family/ticket/mobile/tokenvalid_inform.json',
    //		data: {
    //			memberId: getMemberId(),
    //			token: getMLCPHeaderCookie('token'),
    //			cookieToken: 'N',
    //			cpId: getCookie("POC_IC")
    //		},
    //		dataType: 'jsonp',
    //		success: function(o) {
    //			// 유효하지 않은 토큰일 경우 로그아웃
 ...
 */
function convertStringToDate(pDateString) {
...
function getMUACHeaderCookie(Name) {
    ...
    cookieNameArray['loginDate'] = arrStr[8];
...
function logout(locationType,returnPage){
	...
	var url = "/muid/family/ticket/logout/mobile/logout_inform.htm";
	
	var currentProtocol = document.location.href;
	if(currentProtocol.indexOf("member.melon.com")<0){
		url = "https://member.melon.com"+url;
	}
...
function Nethru_getCookieVal(offset) {
		...
		if(objectId!=undefined && objectId!=''){
		    ...
		    if (headerLayout == null) {
		    	...
		    	if(pageCode=='LOGIN' || pageCode=='EMAILRECEIVECANCEL'){
					...
					headerLayout.innerHTML += "				<li class=''><a href='http://www.melon.com/artistplus/todayupdate/index.htm' class='main_menu menu06' title='아티스트+'><span>아티스트+</span></a></li>";
					...
					if(isMelonLogin()){
						...
						headerLayout.innerHTML += "<a href='https://member.melon.com/muid/web/help/myinfointro_inform.htm'>"+getMemberId()+"</a></span> 님</span>";
			...
			if(pageCode=='LOGIN' || pageCode=='EMAILRECEIVECANCEL'){
				...
				document.write("<div>");
				document.write("<h1><a href=\"javascript:MemberEtc.goPage('MAIN');\" title='Melon 메인 - 페이지 이동'><img src='https://cdnimg.melon.co.kr/resource/image/web/member/img_logo.png' width='85' height='32' alt='Melon' /></a></h1>");
				document.write("</div>");
				document.write("</div>");
			}else{
				var cssHeader = "";
				...
				document.write("<h1><a href=\"javascript:MemberEtc.goPage('MAIN');\" title='Melon 메인 - 페이지 이동'><img src='//cdnimg.melon.co.kr/resource/image/web/member/img_logo.png' width='85' height='32' alt='Melon' /></a></h1>");
				document.write("		<div id='gnb_menu'>");
				document.write("			<ul>");
				document.write("				<li class='first_child'><a href='http://www.melon.com/chart/index.htm' class='main_menu menu01' title='멜론차트'><span>멜론차트</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/new/index.htm' class='main_menu menu02' title='최신음악'><span>최신음악</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/genre/song_list.htm?classicMenuId=DP0100' class='main_menu menu03' title='장르음악'><span>장르음악</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/dj/today/djtoday_list.htm' class='main_menu menu04' title='멜론DJ'><span>멜론DJ</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/tv/index.htm' class='main_menu menu05' title='멜론TV'><span>멜론TV</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/artistplus/todayupdate/index.htm' class='main_menu menu06' title='아티스트+'><span>아티스트+</span></a></li>");
				document.write("				<li class=''><a href='http://www.melon.com/musicstory/today/index.htm' class='main_menu menu07' title='뮤직스토리'><span>뮤직스토리</span></a></li>");
				...
				document.write("						<ul>");
				document.write("							<li class=''><a href='http://www.melon.com/smartradio/index.htm' title='스마트라디오'><span class='menu_more m1'>스마트라디오</span></a></li>");
				document.write("							<li class=''><a href='http://www.melon.com/flac/index.htm' title='원음전용관'><span class='menu_more m2'>원음전용관</span></a></li>");
				document.write("							<li class=''><a href='http://www.melon.com/edu/index.htm' title='어학'><span class='menu_more m3'>어학</span></a></li>");
				document.write("							<li class=''><a href='http://www.melon.com/customer/announce/index.htm' title='공지사항'><span class='menu_more m4'>공지사항</span></a></li>");
				document.write("						</ul>");
				document.write("						<ul>");
				document.write("							<li class=''><a href='http://www.melon.com/commerce/pamphlet/web/sale_listMainView.htm' title='이용권구매'><span class='menu_more m9'>이용권구매</span></a></li>");
				document.write("							<li class=''><a href='javascript:goMyPageAddCash();' title='멜론캐쉬충전'><span class='menu_more m6'>멜론캐쉬충전</span></a></li>");
				document.write("							<li class=''><a href='http://www.melon.com/event/index.htm' title='이벤트'><span class='menu_more m7'>이벤트</span></a></li>");
				document.write("							<li class=''><a href='http://faqs2.melon.com/customer/index.htm' title='고객센터'><span class='menu_more m8'>고객센터</span></a></li>");
				document.write("						</ul>");
				document.write("					</div>");
				document.write("				</li>");
				document.write("			</ul>");
				...
				if(isMelonLogin()){
					...
					document.write("<a href='https://member.melon.com/muid/web/help/myinfointro_inform.htm'>"+getMemberId()+"</a></span> 님</span>");
	...
	function memberFooter(pageCode,errorCode){
		...
		if(errorCode != 'ERL069'){
			...
			document.write("		<li class='first_child'><a href='http://www.iloen.com/' title='회사소개 - 새 창' target='_blank'>회사소개</a></li>");
			document.write("		<li><a href='http://info.melon.com/terms/web/terms1_1.html' title='이용약관 - 페이지 이동'>이용약관</a></li>");
			document.write("		<li><a href='http://info.melon.com/terms/web/terms3.html' title='개인정보취급방침 - 페이지 이동'><strong>개인정보취급방침</strong></a></li>");
			document.write("		<li><a href='http://info.melon.com/terms/web/terms5_1.html' title='청소년보호정책 - 페이지 이동'>청소년보호정책</a></li>");
			document.write("		<li><a href='http://faqs2.melon.com/customer/faq/informFaq.htm?no=1&amp;faqId=QUES20140616000001&amp;SEARCH_KEY=&amp;SEARCH_PAR_CATEGORY=CATE20130909000006&amp;SEARCH_CATEGORY=CATE20130909000021' title='제휴/프로모션문의 - 새 창' target='_blank'>제휴/프로모션문의</a></li>");
			document.write("		<li><a href=\"javascript:MemberEtc.goPage('EMAIL_COL_REJECT',1,384,331);\" title='이메일주소무단수집거부  - 새 창'>이메일주소무단수집거부 </a></li>");
			document.write("		<li><a href='http://faqs2.melon.com/customer/index.htm' title='고객센터 - 새 창' target='_blank'>고객센터</a></li>");
			document.write("		<li><a href='http://partner.melon.com' title='파트너센터 - 새 창' target='_blank'>파트너센터</a></li>");
			document.write("</ul>");
			document.write("<p>");
			document.write("		<span class='first'>서울시 강남구 테헤란로 103길 17 정석빌딩</span><span>대표이사 : 신원수</span><span>사업자등록번호 : 138-81-05876</span><span>통신판매업 신고번호 : 제2011-서울강남-02008호 <a href='http://www.ftc.go.kr/info/bizinfo/communicationView.jsp?apv_perm_no=2011322016230202008&area1=&area2=&currpage=2&searchKey=01&searchVal=%EB%A1%9C%EC%97%94&stdate=&endate=' class='btn-info' title='사업자정보확인'>사업자정보확인</a></span>");
			document.write("		<span class='first'>문의전화(평일 09:00~18:00) : 1566-7727 (유료)</span><span>© LOEN Entertainment, Inc. All rights reserved.</span>");
			document.write("</p>");
			document.write("</div>");
		}
	}
